...
class TranscribeServiceException extends ServiceException {
    constructor(options) {
        super(options);
...
class TranscribeClient extends Client {
    config;
...
const command = makeBuilder(commonParams, "Transcribe", "TranscribeClient", getEndpointPlugin);
const _ep0 = {};
const _mw0 = (Command, cs, config, o) => [];

class CreateCallAnalyticsCategoryCommand extends command(_ep0, _mw0, "CreateCallAnalyticsCategory", CreateCallAnalyticsCategory$) {
}

class CreateLanguageModelCommand extends command(_ep0, _mw0, "CreateLanguageModel", CreateLanguageModel$) {
}

class CreateMedicalVocabularyCommand extends command(_ep0, _mw0, "CreateMedicalVocabulary", CreateMedicalVocabulary$) {
}

class CreateVocabularyCommand extends command(_ep0, _mw0, "CreateVocabulary", CreateVocabulary$) {
}

class CreateVocabularyFilterCommand extends command(_ep0, _mw0, "CreateVocabularyFilter", CreateVocabularyFilter$) {
}

class DeleteCallAnalyticsCategoryCommand extends command(_ep0, _mw0, "DeleteCallAnalyticsCategory", DeleteCallAnalyticsCategory$) {
}

class DeleteCallAnalyticsJobCommand extends command(_ep0, _mw0, "DeleteCallAnalyticsJob", DeleteCallAnalyticsJob$) {
}

class DeleteLanguageModelCommand extends command(_ep0, _mw0, "DeleteLanguageModel", DeleteLanguageModel$) {
}

class DeleteMedicalScribeJobCommand extends command(_ep0, _mw0, "DeleteMedicalScribeJob", DeleteMedicalScribeJob$) {
}

class DeleteMedicalTranscriptionJobCommand extends command(_ep0, _mw0, "DeleteMedicalTranscriptionJob", DeleteMedicalTranscriptionJob$) {
}

class DeleteMedicalVocabularyCommand extends command(_ep0, _mw0, "DeleteMedicalVocabulary", DeleteMedicalVocabulary$) {
}

class DeleteTranscriptionJobCommand extends command(_ep0, _mw0, "DeleteTranscriptionJob", DeleteTranscriptionJob$) {
}

class DeleteVocabularyCommand extends command(_ep0, _mw0, "DeleteVocabulary", DeleteVocabulary$) {
}

class DeleteVocabularyFilterCommand extends command(_ep0, _mw0, "DeleteVocabularyFilter", DeleteVocabularyFilter$) {
}

class DescribeLanguageModelCommand extends command(_ep0, _mw0, "DescribeLanguageModel", DescribeLanguageModel$) {
}

class GetCallAnalyticsCategoryCommand extends command(_ep0, _mw0, "GetCallAnalyticsCategory", GetCallAnalyticsCategory$) {
}

class GetCallAnalyticsJobCommand extends command(_ep0, _mw0, "GetCallAnalyticsJob", GetCallAnalyticsJob$) {
}

class GetMedicalScribeJobCommand extends command(_ep0, _mw0, "GetMedicalScribeJob", GetMedicalScribeJob$) {
}

class GetMedicalTranscriptionJobCommand extends command(_ep0, _mw0, "GetMedicalTranscriptionJob", GetMedicalTranscriptionJob$) {
}

class GetMedicalVocabularyCommand extends command(_ep0, _mw0, "GetMedicalVocabulary", GetMedicalVocabulary$) {
}

class GetTranscriptionJobCommand extends command(_ep0, _mw0, "GetTranscriptionJob", GetTranscriptionJob$) {
}

class GetVocabularyCommand extends command(_ep0, _mw0, "GetVocabulary", GetVocabulary$) {
}

class GetVocabularyFilterCommand extends command(_ep0, _mw0, "GetVocabularyFilter", GetVocabularyFilter$) {
}

class ListCallAnalyticsCategoriesCommand extends command(_ep0, _mw0, "ListCallAnalyticsCategories", ListCallAnalyticsCategories$) {
}

class ListCallAnalyticsJobsCommand extends command(_ep0, _mw0, "ListCallAnalyticsJobs", ListCallAnalyticsJobs$) {
}

class ListLanguageModelsCommand extends command(_ep0, _mw0, "ListLanguageModels", ListLanguageModels$) {
}

class ListMedicalScribeJobsCommand extends command(_ep0, _mw0, "ListMedicalScribeJobs", ListMedicalScribeJobs$) {
}

class ListMedicalTranscriptionJobsCommand extends command(_ep0, _mw0, "ListMedicalTranscriptionJobs", ListMedicalTranscriptionJobs$) {
}

class ListMedicalVocabulariesCommand extends command(_ep0, _mw0, "ListMedicalVocabularies", ListMedicalVocabularies$) {
}

class ListTagsForResourceCommand extends command(_ep0, _mw0, "ListTagsForResource", ListTagsForResource$) {
}

class ListTranscriptionJobsCommand extends command(_ep0, _mw0, "ListTranscriptionJobs", ListTranscriptionJobs$) {
}

class ListVocabulariesCommand extends command(_ep0, _mw0, "ListVocabularies", ListVocabularies$) {
}

class ListVocabularyFiltersCommand extends command(_ep0, _mw0, "ListVocabularyFilters", ListVocabularyFilters$) {
}

class StartCallAnalyticsJobCommand extends command(_ep0, _mw0, "StartCallAnalyticsJob", StartCallAnalyticsJob$) {
}

class StartMedicalScribeJobCommand extends command(_ep0, _mw0, "StartMedicalScribeJob", StartMedicalScribeJob$) {
}

class StartMedicalTranscriptionJobCommand extends command(_ep0, _mw0, "StartMedicalTranscriptionJob", StartMedicalTranscriptionJob$) {
}

class StartTranscriptionJobCommand extends command(_ep0, _mw0, "StartTranscriptionJob", StartTranscriptionJob$) {
}
...
class UpdateCallAnalyticsCategoryCommand extends command(_ep0, _mw0, "UpdateCallAnalyticsCategory", UpdateCallAnalyticsCategory$) {
}

class UpdateMedicalVocabularyCommand extends command(_ep0, _mw0, "UpdateMedicalVocabulary", UpdateMedicalVocabulary$) {
}

class UpdateVocabularyCommand extends command(_ep0, _mw0, "UpdateVocabulary", UpdateVocabulary$) {
}

class UpdateVocabularyFilterCommand extends command(_ep0, _mw0, "UpdateVocabularyFilter", UpdateVocabularyFilter$) {
}

const paginateListCallAnalyticsCategories = createPaginator(TranscribeClient, ListCallAnalyticsCategoriesCommand, "NextToken", "NextToken", "MaxResults");

const paginateListCallAnalyticsJobs = createPaginator(TranscribeClient, ListCallAnalyticsJobsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListLanguageModels = createPaginator(TranscribeClient, ListLanguageModelsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListMedicalScribeJobs = createPaginator(TranscribeClient, ListMedicalScribeJobsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListMedicalTranscriptionJobs = createPaginator(TranscribeClient, ListMedicalTranscriptionJobsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListMedicalVocabularies = createPaginator(TranscribeClient, ListMedicalVocabulariesCommand, "NextToken", "NextToken", "MaxResults");

const paginateListTranscriptionJobs = createPaginator(TranscribeClient, ListTranscriptionJobsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListVocabularies = createPaginator(TranscribeClient, ListVocabulariesCommand, "NextToken", "NextToken", "MaxResults");

const paginateListVocabularyFilters = createPaginator(TranscribeClient, ListVocabularyFiltersCommand, "NextToken", "NextToken", "MaxResults");
...
const CallAnalyticsFeature = {
    GENERATIVE_SUMMARIZATION: "GENERATIVE_SUMMARIZATION",
};
const CallAnalyticsSkippedReasonCode = {
    FAILED_SAFETY_GUIDELINES: "FAILED_SAFETY_GUIDELINES",
    INSUFFICIENT_CONVERSATION_CONTENT: "INSUFFICIENT_CONVERSATION_CONTENT",
};
const CallAnalyticsJobStatus = {
    COMPLETED: "COMPLETED",
    FAILED: "FAILED",
