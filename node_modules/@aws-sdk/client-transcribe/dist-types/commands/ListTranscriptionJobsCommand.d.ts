...
declare const ListTranscriptionJobsCommand_base: {
    new (input: ListTranscriptionJobsCommandInput): import("@smithy/core/client").CommandImpl<ListTranscriptionJobsCommandInput, ListTranscriptionJobsCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListTranscriptionJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListTranscriptionJobsCommandInput, ListTranscriptionJobsCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
