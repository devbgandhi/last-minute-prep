...
declare const GetTranscriptionJobCommand_base: {
    new (input: GetTranscriptionJobCommandInput): import("@smithy/core/client").CommandImpl<GetTranscriptionJobCommandInput, GetTranscriptionJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTranscriptionJobCommandInput): import("@smithy/core/client").CommandImpl<GetTranscriptionJobCommandInput, GetTranscriptionJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
