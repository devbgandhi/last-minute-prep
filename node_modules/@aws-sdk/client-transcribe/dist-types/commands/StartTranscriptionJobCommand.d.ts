...
declare const StartTranscriptionJobCommand_base: {
    new (input: StartTranscriptionJobCommandInput): import("@smithy/core/client").CommandImpl<StartTranscriptionJobCommandInput, StartTranscriptionJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartTranscriptionJobCommandInput): import("@smithy/core/client").CommandImpl<StartTranscriptionJobCommandInput, StartTranscriptionJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
