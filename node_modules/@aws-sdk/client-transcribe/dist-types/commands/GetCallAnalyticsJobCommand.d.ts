...
declare const GetCallAnalyticsJobCommand_base: {
    new (input: GetCallAnalyticsJobCommandInput): import("@smithy/core/client").CommandImpl<GetCallAnalyticsJobCommandInput, GetCallAnalyticsJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCallAnalyticsJobCommandInput): import("@smithy/core/client").CommandImpl<GetCallAnalyticsJobCommandInput, GetCallAnalyticsJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
