...
declare const StartCallAnalyticsJobCommand_base: {
    new (input: StartCallAnalyticsJobCommandInput): import("@smithy/core/client").CommandImpl<StartCallAnalyticsJobCommandInput, StartCallAnalyticsJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartCallAnalyticsJobCommandInput): import("@smithy/core/client").CommandImpl<StartCallAnalyticsJobCommandInput, StartCallAnalyticsJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
